...
| `openxml_parser_public_sample_resume.docx` | DOCX | Resume layout (bold labels, lists, tables; no Word Heading styles — MD is mostly flat, JSON has style metadata) |
...
uv run openxml-parser samples/openxml_parser_public_sample_resume.docx --output-md out/resume.md
...
Proprietary documents belong in `private_example/` (gitignored), not here.
